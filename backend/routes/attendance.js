...
router.post('/import', authenticateToken, authorizeRoles('hr', 'ceo', 'co-founder'), AttendanceController.importAttendanceCSV);

router.post('/manual-entry', authenticateToken, authorizeRoles('hr', 'ceo', 'co-founder'), AttendanceController.createManualEntry);

router.put('/:attendanceId', authenticateToken, authorizeRoles('hr', 'ceo', 'co-founder'), AttendanceController.updateAttendance);
