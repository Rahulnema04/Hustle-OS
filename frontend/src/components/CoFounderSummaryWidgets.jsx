                            ...
                            <div className="flex flex-col h-full justify-center">
                                ...
                                <div className="relative flex justify-center items-center mb-5 -mt-3">
                                    ...
                                    <div className="absolute right-0 top-0 bg-white/5 rounded px-2 py-1 border border-white/10">
                                        <div className="text-zinc-500 text-[10px] font-medium">Avg: <span className="text-white font-bold text-xs">{mockPerformance.avgProductivity}</span></div>
                                    </div>
                                </div>

                                {/* Performer Cards - 3 Columns */}
                                <div className="grid grid-cols-3 gap-2">
                                    {mockPerformance.topPerformers.slice(0, 3).map((performer, index) => {
