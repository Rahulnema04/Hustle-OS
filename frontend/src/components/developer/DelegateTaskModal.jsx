            ...
            <div className="bg-gradient-to-br from-zinc-900 to-black rounded-2xl shadow-2xl border border-white/10 w-full max-w-lg mx-4">
                ...
                <div className="flex justify-between items-center p-6 border-b border-white/10">
                    <div>
                        ...
                        <p className="text-sm text-zinc-400 mt-0.5">Assign this task to one of your interns</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-zinc-300 mb-2">
                            Select Mentee <span className="text-red-400">*</span>
                        </label>
                        {loadingMentees ? (
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Add any special instructions or context for your mentee..."
                            rows={3}
